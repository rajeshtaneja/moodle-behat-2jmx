...
class util {
    ...
    public static function get_json_config_path($checkdirperm = false) {
        ...
        if (file_exists(__DIR__ . '/../testplan.json')) {
            ...
            $jsonconfig = __DIR__ . '/../testplan.json';

        } else if (file_exists(__DIR__ . '/../../../testplan.json')) {
            ...
            if (is_writeable(__DIR__ . '/../')) {
                ...
                self::performance_exception('No default testplan.json found and tool dir is not writable', 1);
            }
